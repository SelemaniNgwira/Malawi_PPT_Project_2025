...
# Acceptance of digital health surveillance platform.
...
model_data |> 
  select( demo_v, Acceptance_level) |> 
  tbl_summary(by = Acceptance_level,
              missing = "no", 
  ...
  modify_caption("**Acceptance level of digital health tool**") %>%
   add_ci() %>%
   add_p() %>%
  modify_fmt_fun(
